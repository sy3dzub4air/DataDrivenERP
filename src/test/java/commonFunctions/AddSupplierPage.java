...
public class AddSupplierPage {
	...
	// Define repository for add Supplier page elements
		...
		public boolean addSupplier(String Sname, String Address, String City, String Country, String Cperson, String Pnumber,
				String Email, String Mnumber, String Notes) throws Throwable
		{
			...
			Thread.sleep(2000);
			String Act_Data = this.objSupplierTable.getText();
